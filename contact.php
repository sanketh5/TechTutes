				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="contact-form">
							...
							<form method="post" action="">
								...
								<button class="main-button icon-button pull-right" onclick="send()">Send Message</button>
							</form>
						</div>
					</div>
					<!-- /contact form -->
					...
					<div class="col-md-5 col-md-offset-1">
						...
						<ul class="contact-details">
                            ...
                            <a href="callto:7588425170"><li><i class="fa fa-phone"></i>8788513442</li></a>
							<li><b><i class="fa fa-map-marker"></i>Gachibowlli Hydrabad</b></li>
						</ul>
...
<!-- social -->
					<div class="col-md-4 col-md-push-8">
						<ul class="footer-social">
							...
							<li><a href="https://www.instagram.com/techtutes/" class="instagram"><i class="fa fa-instagram"></i></a></li>
...
<script type="text/javascript">
  function send() {
    var link = 'mailto:sankethdesuwar5@gmail.com'+'?subject=Message from '
